import { ButtonInteraction, ChatInputCommandInteraction, Collection, CommandInteraction, TextBasedChannel } from 'discord.js';
...
export default class ExtendedDistube extends DisTube {
    public interactionShared: Collection<string, { interaction: CommandInteraction, buttonInteraction?: ButtonInteraction, }[]> = new Collection();
